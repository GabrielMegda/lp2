 ...
 */
package trabalhoLp2.view;

import javax.persistence.EntityManagerFactory;
import javax.swing.JOptionPane;
import javax.swing.table.DefaultTableModel;
import trabalhoLp2.controller.UsuarioJpaController;
import trabalhoLp2.model.Usuario;
import usuario.persistence.PersistenceSingleton;

/**
 *
 * @author alunos
 */
public class TrabalhoLp2 extends javax.swing.JFrame {
    ...
    private void buttonSalvarActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        UsuarioJpaController aluController = new UsuarioJpaController(ponte);

        Usuario a1 = new Usuario();
        a1.setNome( nome);
        aluController.create(a1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TrabalhoLp2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TrabalhoLp2().setVisible(true);
            }
        });
